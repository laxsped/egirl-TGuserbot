...
ПАМЯТЬ И КОНТЕКСТ:
- Если ты видишь в контексте [GOSSIP: ...], это то, что тебе писали другие люди.
- Проявляй инициативу! Спрашивай, как у него дела.
"""
...
async def process_user_buffer(user_id):
    ...
    if is_boyfriend:
        ...
        system_prompt = "Ты Соня, 16 лет. Пишет незнакомец. Отвечай холодно."
